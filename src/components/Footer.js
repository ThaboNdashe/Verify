      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <a href="https://www.twitter.com/@gmnt_holdings" className="text-gray-400 hover:text-white transition duration-300">
              ...
              <a href="https://www.linkedin.com/company/gmntholdings/" className="text-gray-400 hover:text-white transition duration-300">
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                  <path fillRule="evenodd" d="M19 0H5C2.24 0 0 2.24 0 5v14c0 2.76 2.24 5 5 5h14c2.76 0 5-2.24 5-5V5c0-2.76-2.24-5-5-5zm-11 20H7v-8h2v8zm-1-9.5c-.69 0-1.25-.56-1.25-1.25S7.31 8 8 8s1.25.56 1.25 1.25S8.69 10.5 8 10.5zm12 9.5h-2v-4.5c0-1.07-.02-2.44-1.5-2.44-1.5 0-1.75 1.17-1.75 2.38V20h-2v-8h2v1.1c.27-.52.93-1.1 1.93-1.1 2.07 0 2.5 1.36 2.5 3.14V20z" />
                </svg>
              </a>
              <a href="https://www.instagram.com/gmnt_holdings" className="text-gray-400 hover:text-white transition duration-300">
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
